...
public class GImage {
	...
	public static void shadowDraw(Texture tex, float x, float y, float w, float h, float r, float g, float b, float t) {
		glPushMatrix();
		{
			if (tex != null)
				tex.bind();
	...
	public static void drawDisplayBar(Texture tex, float x, float y, float w, float h, float r,float g, float b, float t, float full, float current) {
		glPushMatrix();
		{
			if (tex != null)
				tex.bind();
